...
/**
 * Garde d'invocation de la fonction de reglement (transferForTrade) : son
 * autorisation derive du trade cosigne (R05), pas de l'identite de l'appelant -
 * mais elle ne doit etre atteignable QUE via le coordinateur dvp, sinon un
 * client pourrait executer une jambe sans l'autre et briser l'invariant DvP.
 ...
 * tient du trade cosigne) : un rappel wcbdc->dvp.getTrade est impossible,
